...
const ReletedDoctors = ({docId,speciality}) => {
    ...
    <div className='flex flex-col items-center gap-4 my-16
     text-gray-900 md:mx-10'>
                   ...
                   duration-300' key={index}>
                    ...
                    <div className='p-4'>
                        <div className=' flex items-center
                         gap-2 text-sm text-green-300'>
                            <p className=' w-2 h-2
                            bg-green-500 rounded-full'></p><p>Available</p>
                        </div>
      ...
      onClick={()=>{navigate('/doctors'); scrollTo(0,0)}}
       className=' bg-blue-100 text-gray-600 px-12
      py-3 rounded-full mt-10'>More</button>
    </div>
  )
}
ReletedDoctors.propTypes = {
